...
///   Generic over the discriminator (<see cref="IIndexNarrower" />, as the eager ones), so the overloads
///   bind on the top-level builder and inside <c>Or</c> / <c>If</c> branches alike.
/// </summary>
